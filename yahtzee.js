...
// The below function is for naming the section in the table
...
// The below function is for changing the coustume of the dice
    if(dice1Lock == 0){
        ...
        if( rand1 == 1){
            dice1.setAttribute("src","photoForYahtzee/1.png");
        }
        else if( rand1 == 2){
            dice1.setAttribute("src","photoForYahtzee/2.png");
        }
        else if( rand1 == 3){
            dice1.setAttribute("src","photoForYahtzee/3.png");
        }
        else if( rand1 == 4){
            dice1.setAttribute("src","photoForYahtzee/4.png");
        }
        else if( rand1 == 5){
            dice1.setAttribute("src","photoForYahtzee/5.png");
        }
        else if( rand1 == 6){
            dice1.setAttribute("src","photoForYahtzee/6.png");
        }
    }
    ...
    if(dice2Lock == 0){
        ...
        if( rand2 == 1){
            dice2.setAttribute("src","photoForYahtzee/1.png");
        }
        else if( rand2 == 2){
            dice2.setAttribute("src","photoForYahtzee/2.png");
        }
        else if( rand2 == 3){
            dice2.setAttribute("src","photoForYahtzee/3.png");
        }
        else if( rand2 == 4){
            dice2.setAttribute("src","photoForYahtzee/4.png");
        }
        else if( rand2 == 5){
            dice2.setAttribute("src","photoForYahtzee/5.png");
        }
        else if( rand2 == 6){
            dice2.setAttribute("src","photoForYahtzee/6.png");
        }
    }
    if(dice3Lock == 0){
    
        if( rand3 == 1){
            dice3.setAttribute("src","photoForYahtzee/1.png");
        }
        else if( rand3 == 2){
            dice3.setAttribute("src","photoForYahtzee/2.png");
        }
        else if( rand3 == 3){
            dice3.setAttribute("src","photoForYahtzee/3.png");
        }
        else if( rand3 == 4){
            dice3.setAttribute("src","photoForYahtzee/4.png");
        }
        else if( rand3 == 5){
            dice3.setAttribute("src","photoForYahtzee/5.png");
        }
        else if( rand3 == 6){
            dice3.setAttribute("src","photoForYahtzee/6.png");
        }
    }
    if(dice4Lock == 0){
    
        if( rand4 == 1){
            dice4.setAttribute("src","photoForYahtzee/1.png");
        }
        else if( rand4 == 2){
            dice4.setAttribute("src","photoForYahtzee/2.png");
        }
        else if( rand4 == 3){
            dice4.setAttribute("src","photoForYahtzee/3.png");
        }
        else if( rand4 == 4){
            dice4.setAttribute("src","photoForYahtzee/4.png");
        }
        else if( rand4 == 5){
            dice4.setAttribute("src","photoForYahtzee/5.png");
        }
        else if( rand4 == 6){
            dice4.setAttribute("src","photoForYahtzee/6.png");
        }
    }
    ...
    if(dice5Lock == 0){
        ...
        if( rand5 == 1){
            dice5.setAttribute("src","photoForYahtzee/1.png");
        }
        else if( rand5 == 2){
            dice5.setAttribute("src","photoForYahtzee/2.png");
        }
        else if( rand5 == 3){
            dice5.setAttribute("src","photoForYahtzee/3.png");
        }
        else if( rand5 == 4){
            dice5.setAttribute("src","photoForYahtzee/4.png");
        }
        else if( rand5 == 5){
            dice5.setAttribute("src","photoForYahtzee/5.png");
        }
        else if( rand5 == 6){
            dice5.setAttribute("src","photoForYahtzee/6.png");
        }
    }
...
console.log("need to work "+rollDiceDisable);
rollCount++;
...
function scoreLocForpl1(idName){
    if(scoreLock == 1){
        ...
        if(totalCheck == 14 && sumCountForPl1 == 6 && sumCountForPl2 == 6){
            let total1 = onesLock+twosLock+threeLock+foursLock+fivesLock+sixLock+chanceLock+scoreForFullpl1+scoreForLargepl1+scoreForSmallpl1+scoreForyahtzeepl1+scoreForyahtzeepl1+fourOfKindScore+threeOfKindScore;
            document.getElementById("pl1Total").innerText = total1;
            let total2 = onesLock2+twosLock2+threeLock2+foursLock2+fivesLock2+sixLock2+chanceLock2+scoreForFullpl2+scoreForLargepl2+scoreForSmallpl2+scoreForyahtzeepl2+scoreForyahtzeepl2+fourOfKindScore2+threeOfKindScore2;
...
function smallStraight(){
    if(onesOut[10] == 0){
        ...
        for(let i = 0 ; i < test.length ; i++){
            if(case1.includes(noDup[i])){
                count1++;
            }
            if(case2.includes(noDup[i])){
                count2++;
            }
            if(case3.includes(noDup[i])){
                count3++;
            }   
        }
...
function largeStraight(){
    if(onesOut[11] == 0){
        ...
        for(let i = 0 ; i < noDup2.length ; i++){
            if(case1.includes(noDup2[i])){
                count1++
            }
            if(case2.includes(noDup2[i])){
                count2++;
            }
        }
...
// These are the letiables for rolling the dice for player2  
...
//  The below function is for rolling the dice for player 2
 ...
 function rollDicePl2(){
    // These set the function for dice to change the position
console.log(rollCount);
    ...
    if(pointLock1ForPl2 == 0){
         rand1For2 = Math.floor(Math.random()*6+1);
    }
    if(pointLock2ForPl2 == 0){
         rand2For2 = Math.floor(Math.random()*6+1);
    }
    if(pointLock3ForPl2 == 0){
         rand3For2 = Math.floor(Math.random()*6+1);
    }
    if(pointLock4ForPl2 == 0){
         rand4For2 = Math.floor(Math.random()*6+1);
    }
    if(pointLock5ForPl2 == 0){
         rand5For2 = Math.floor(Math.random()*6+1);
    }
    ...
    if(dice1Lock2 == 0){
        ...
        if( rand1For2 == 1){
            dice1ForPl2.setAttribute("src","photoForYahtzee/1.png");
        }
        else if( rand1For2 == 2){
            dice1ForPl2.setAttribute("src","photoForYahtzee/2.png");
        }
        else if( rand1For2 == 3){
            dice1ForPl2.setAttribute("src","photoForYahtzee/3.png");
        }
        else if( rand1For2 == 4){
            dice1ForPl2.setAttribute("src","photoForYahtzee/4.png");
        }
        else if( rand1For2 == 5){
            dice1ForPl2.setAttribute("src","photoForYahtzee/5.png");
        }
        else if( rand1For2 == 6){
            dice1ForPl2.setAttribute("src","photoForYahtzee/6.png");
        }
    }
    ...
    if(dice2Lock2 == 0){
        ...
        if( rand2For2 == 1){
            dice2ForPl2.setAttribute("src","photoForYahtzee/1.png");
        }
        else if( rand2For2 == 2){
            dice2ForPl2.setAttribute("src","photoForYahtzee/2.png");
        }
        else if( rand2For2 == 3){
            dice2ForPl2.setAttribute("src","photoForYahtzee/3.png");
        }
        else if( rand2For2 == 4){
            dice2ForPl2.setAttribute("src","photoForYahtzee/4.png");
        }
        else if( rand2For2 == 5){
            dice2ForPl2.setAttribute("src","photoForYahtzee/5.png");
        }
        else if( rand2For2 == 6){
            dice2ForPl2.setAttribute("src","photoForYahtzee/6.png");
        }
    }
    if(dice3Lock2 == 0){

        if( rand3For2 == 1){
            dice3ForPl2.setAttribute("src","photoForYahtzee/1.png");
        }
        else if( rand3For2 == 2){
            dice3ForPl2.setAttribute("src","photoForYahtzee/2.png");
        }
        else if( rand3For2 == 3){
            dice3ForPl2.setAttribute("src","photoForYahtzee/3.png");
        }
        else if( rand3For2 == 4){
            dice3ForPl2.setAttribute("src","photoForYahtzee/4.png");
        }
        else if( rand3For2 == 5){
            dice3ForPl2.setAttribute("src","photoForYahtzee/5.png");
        }
        else if( rand3For2 == 6){
            dice3ForPl2.setAttribute("src","photoForYahtzee/6.png");
        }
    }
    if(dice4Lock2 == 0){

        if( rand4For2 == 1){
            dice4ForPl2.setAttribute("src","photoForYahtzee/1.png");
        }
        else if( rand4For2 == 2){
            dice4ForPl2.setAttribute("src","photoForYahtzee/2.png");
        }
        else if( rand4For2 == 3){
            dice4ForPl2.setAttribute("src","photoForYahtzee/3.png");
        }
        else if( rand4For2 == 4){
            dice4ForPl2.setAttribute("src","photoForYahtzee/4.png");
        }
        else if( rand4For2== 5){
            dice4ForPl2.setAttribute("src","photoForYahtzee/5.png");
        }
        else if( rand4For2 == 6){
            dice4ForPl2.setAttribute("src","photoForYahtzee/6.png");
        }
    }
    ...
    if(dice5Lock2 == 0){
        ...
        if( rand5For2 == 1){
            dice5ForPl2.setAttribute("src","photoForYahtzee/1.png");
        }
        else if( rand5For2 == 2){
            dice5ForPl2.setAttribute("src","photoForYahtzee/2.png");
        }
        else if( rand5For2 == 3){
            dice5ForPl2.setAttribute("src","photoForYahtzee/3.png");
        }
        else if( rand5For2 == 4){
            dice5ForPl2.setAttribute("src","photoForYahtzee/4.png");
        }
        else if( rand5For2 == 5){
            dice5ForPl2.setAttribute("src","photoForYahtzee/5.png");
        }
        else if( rand5For2 == 6){
            dice5ForPl2.setAttribute("src","photoForYahtzee/6.png");
        }
    }
    for(let i = 0 ; i < 15 ;i++){
        if( i != 7){
...
function init2(){
    ...
    dice1ForPl2.style.top= null;
    dice1ForPl2.style.left= null;

    dice2ForPl2.style.top= null;
    dice2ForPl2.style.left= null;

    dice3ForPl2.style.top= null;
    dice3ForPl2.style.left= null;

    dice4ForPl2.style.top= null;
    dice4ForPl2.style.left= null;

    dice5ForPl2.style.top= null;
    dice5ForPl2.style.left= null;
    ...
    console.log(dice1Lock2,dice2Lock2,dice3Lock2,dice4Lock2,dice5Lock2);
